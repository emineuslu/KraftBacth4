...
/*
        ...
        x=x+100;    // x=100+100  yanı boylede yazılır x+=100
        x +=100;    // ıkı satırdakı de aynı seyı ıfade eder
        ...
        bakiye-=2200;        //2200 harcadı
        System.out.println("bakiye = " + bakiye);

        double maas =42500.50;
        System.out.println("maas = " + maas);

        maas*=2;   // maas*2=ıkı katına cıktı
        ...
        System.out.println("1130TL için: "+ikiyuzluk+" tane ikiyuzlük banknot " +yuzluk+"  yuzluk banknot "+yirmilik+" tane yirmilik banknot "+ onluk+" tane onluk banknot odemenız gerekmektedir.");
